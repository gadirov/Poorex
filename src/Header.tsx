      ...
      <Box w="80%" display="flex" flexDirection="column">
        ...
        >
          <Box
            ...
            gap="10px"
          >
            <Text color="#8b9e9e" fontSize="14px">
              Connect with our charity
            </Text>
          ...
          <Box p="10px">
            ...
            >
              <ListItem>
                <Image src="../assests/header/location.png" w="16px" h="16px" />
              </ListItem>
              <ListItem
                color="#8b9e9e"
                mr="20px"
        ...
        <HStack justifyContent="space-between" p="10px 50px">
          ...
          <HStack gap="20px">
            <HStack gap="20px">
              <Image
                src="../assests/header/search.png"
                w="24px"
                h="24px"
                cursor="pointer"
              />
              <Image
                src="../assests/header/user.png"
                w="24px"
                h="24px"
                cursor="pointer"
              />
            ...
            <HStack gap="10px">
              ...
              >
                <Image src="../assests/header/phone.png" w="24px" h="24px" />
              </HStack>
              <Box>
                <Text color="#6e7a7a" fontSize="14px">
                  Call US Anytime
                </Text>
                <Text>
                  <Link
                    href="tel:+98 656 768 6789"
                    fontWeight="700"
                    _hover={{
                      color: "#fe7f4c",
                      cursor: "pointer",
